...
*/
  ...
  function ka(a, b) {
    if (b) {
      ...
      f != e &&
        null != f &&
        ha(c, d, { configurable: !0, writable: !0, value: f });
    }
  }
  var la =
  ...
  function na(a) {
    return (
      (Object.prototype.hasOwnProperty.call(a, y) && a[y]) || (a[y] = ++oa)
    );
  }
  ...
  function Ra(a) {
    var b = new I(
      Ma,
      H instanceof G && H.constructor === G && H.a === La
        ? H.b
        : "type_error:Const"
    );
    a.src = (b instanceof I && b.constructor === I && b.a === Na
      ? b.b
  ...
  function Sa(a, b) {
    ...
    if (a) {
      ...
      for (c = d = 0; (e = f[c]); c++) {
        var h = e.className,
          m;
        if ((m = "function" == typeof h.split)) m = 0 <= ta(h.split(/\s+/), a);
        m && (g[d++] = e);
      }
      g.length = d;
      return g;
  ...
  var $a = {
      M: "allow-forms",
      N: "allow-modals",
      O: "allow-orientation-lock",
      P: "allow-pointer-lock",
      R: "allow-popups",
      S: "allow-popups-to-escape-sandbox",
      T: "allow-presentation",
      U: "allow-same-origin",
      V: "allow-scripts",
      W: "allow-top-navigation",
      X: "allow-top-navigation-by-user-activation"
    },
    bb = Ja(function() {
      return ab();
    });
  ...
  function jb() {
    ...
    "undefined" === typeof a &&
      ...
      (a = function() {
        ...
        e.open();
        e.write(
          J instanceof Oa && J.constructor === Oa && J.b === Pa
            ? J.a
            : "type_error:SafeHtml"
        );
        e.close();
  ...
  function ob() {
    if (r.Promise && r.Promise.resolve) {
      ...
      N = function() {
        var b = rb,
          c;
        !(c = "function" != w(r.setImmediate)) &&
          (c = r.Window && r.Window.prototype) &&
          (c =
            -1 == E.indexOf("Edge") &&
            r.Window.prototype.setImmediate == r.setImmediate);
        c ? (ib || (ib = jb()), ib(b)) : r.setImmediate(b);
      };
  }
  var pb = !1,
    qb = new kb();
  function rb() {
    for (var a; (a = qb.remove()); ) {
      try {
        a.a.call(a.b);
      } catch (c) {
        hb(c);
    ...
    if (c) {
      ...
      if (this.o)
        for (e = 0; e < c.length; e++) {
          var g = c[e];
          ub(this.a[g + 1], this.a[g + 2], d);
        }
      else {
        this.i++;
        try {
          for (e = 0, f = c.length; e < f; e++)
            (g = c[e]), this.a[g + 1].apply(this.a[g + 2], d);
        } finally {
  ...
  k.clear = function(a) {
    if (a) {
      var b = this.b[a];
      b && (B(b, this.B, this), delete this.b[a]);
    ...
    return a && window.yterr
      ? function() {
          try {
            ...
            var b = d,
              c = v("yt.logging.errors.log");
            c
              ? c(b, "ERROR", void 0, void 0, void 0)
              : ((c = wb()),
                c.push([b, "ERROR", void 0, void 0, void 0]),
                vb("ERRORS", c));
            yb(d);
          }
        }
  ...
  function S(a) {
    ...
    try {
      if ((a = a || window.event)) {
        this.event = a;
        for (var b in a) b in Bb || (this[b] = a[b]);
  ...
  var F = v("ytEventsEventsListeners") || {};
  A("ytEventsEventsListeners", F);
  var Cb = v("ytEventsEventsCounter") || { count: 0 };
  A("ytEventsEventsCounter", Cb);
  function Db(a, b, c, d) {
    d = void 0 === d ? {} : d;
    a.addEventListener &&
  ...
  function Kb(a) {
    return (
      Jb[a] ||
      (Jb[a] = String(a).replace(/\-([a-z])/g, function(b, c) {
  ...
  function Mb() {
    ...
    var b;
    a ? (b = a.call(l)) : (b = { next: aa() });
    a = b;
    for (b = a.next(); !b.done; b = a.next()) (b = b.value), b();
  }
  function Nb(a, b) {
    b || (b = document);
    var c = xa(b.getElementsByTagName("yt:" + a)),
      d = "yt-" + a,
      e = b || document;
    d = xa(
  ...
  Pb.prototype.g = function(a) {
    if (
      ...
      if ((a = W[b.id]))
        (a.o = !0), a.o && (B(a.m, a.A, a), (a.m.length = 0)), a.H(b);
    }
  };
  var W = null;
  function Rb() {
    ...
    a: {
      try {
        var c = a.a.top.location.href;
      } catch (f) {
        a = 2;
        break a;
      }
      a = c ? (c === a.b.location.href ? 0 : 1) : 2;
    }
    b = ((b.frm = a), b);
    ...
    b.u_java =
      ...
      K.navigator.javaEnabled();
    K.screen &&
      ((b.u_h = K.screen.height),
      (b.u_w = K.screen.width),
      (b.u_ah = K.screen.availHeight),
      (b.u_aw = K.screen.availWidth),
      (b.u_cd = K.screen.colorDepth));
    K.navigator &&
      K.navigator.plugins &&
      (b.u_nplug = K.navigator.plugins.length);
    K.navigator &&
      K.navigator.mimeTypes &&
      (b.u_nmime = K.navigator.mimeTypes.length);
    return b;
  }
  function Tb() {
    var a = Sb;
    ...
    c = a.a.top;
    try {
      var m = (c || window).document,
        n = "CSS1Compat" == m.compatMode ? m.documentElement : m.body;
      var u = new L(n.clientWidth, n.clientHeight).round();
    } catch (t) {
      u = new L(-12245933, -12245933);
    }
    m = u;
    u = {};
    n = new eb();
    r.SVGElement && r.document.createElementNS && n.set(0);
    c = cb();
    c["allow-top-navigation-by-user-activation"] && n.set(1);
    c["allow-popups-to-escape-sandbox"] && n.set(2);
    r.crypto && r.crypto.subtle && n.set(3);
    r.TextDecoder && r.TextEncoder && n.set(4);
    n = fb(n);
    u.bc = n;
    u.bih = m.height;
    u.biw = m.width;
  ...
  A("yt.ads_.signals_.getAdSignalsString", function(a) {
    a = void 0 === a ? v("yt.ads.biscotti.lastId_") || "" : a;
    var b = Object.assign(Rb(), Tb());
    b.ca_type = "image";
    a && (b.bid = a);
    return Ib(b);
  });
    ...
    if ((a = "string" === typeof a ? c.getElementById(a) : a))
      if (
        ...
        c ||
          ...
          (a = b)),
        (this.a = a),
        this.a.id || (this.a.id = "widget" + na(this.a)),
        (T[this.a.id] = this),
        window.postMessage)
      ) {
        this.g = new P();
  ...
  function Ub(a, b) {
    ...
    window.location.host &&
      (h.origin = window.location.protocol + "//" + window.location.host);
    h.widgetid = a.h;
    window.location.href &&
      B(["debugjs", "debugcss"], function(m) {
        var n = window.location.href;
        var u = n.search(Ya);
        b: {
          var t = 0;
          for (var C = m.length; 0 <= (t = n.indexOf(m, t)) && t < u; ) {
            var D = n.charCodeAt(t - 1);
            if (38 == D || 63 == D)
              if (
                ((D = n.charCodeAt(t + C)), !D || 61 == D || 38 == D || 35 == D)
              )
                break b;
            t += C + 1;
          }
        ...
        if (0 > t) n = null;
          ...
          if (0 > C || C > u) C = u;
          t += m.length + 1;
          n = decodeURIComponent(n.substr(t, C - t).replace(/\+/g, " "));
        }
        null !== n && (h[m] = n);
      });
    c.src = V(a.b, "host") + a.v() + "?" + Xa(h);
    return c;
  }
  k.F = function() {
    this.a && this.a.contentWindow
      ? this.A({ event: "listening" })
  ...
  function Vb(a) {
    ...
    Gb(
      ...
      z(function() {
        window.clearInterval(this.f);
        this.f = Hb(z(this.F, this));
      }, a)
    );
  }
  function Xb(a, b) {
    a.I[b] || ((a.I[b] = !0), Yb(a, "addEventListener", [b]));
  }
  k.A = function(a) {
    a.id = this.h;
    a.channel = "widget";
          ...
          */
          ...
          if (f.name && "SyntaxError" == f.name) {
            if (!(f.message && 0 < f.message.indexOf("target origin ''"))) {
              var d = f,
                e = v("yt.logging.errors.log");
              e
                ? e(d, "WARNING", void 0, void 0, !1, void 0)
                : ((e = wb()),
                  e.push([d, "WARNING", void 0, void 0, !1, void 0]),
                  vb("ERRORS", e));
            }
          } else throw f;
        }
  ...
  k.H = function(a) {
    ...
    switch (b) {
      case "apiInfoDelivery":
        if (x(a)) for (var c in a) this.j[c] = a[c];
        break;
      case "infoDelivery":
        ac(this, a);
        break;
  ...
  function ac(a, b) {
    if (x(b)) for (var c in b) a.l[c] = b[c];
  }
  function bc(a, b) {
    B(
      b,
          ...
          ("getCurrentTime" == c
            ? (this[c] = function() {
                ...
                if (1 == this.l.playerState) {
                  var e =
                    (ra() / 1e3 - this.l.currentTimeLastUpdated_) *
                    this.l.playbackRate;
                  0 < e && (d += Math.min(e, 1));
                }
                return d;
  ...
  k.getVideoEmbedCode = function() {
    ...
    Ea.test(c) &&
      (-1 != c.indexOf("&") && (c = c.replace(ya, "&amp;")),
      -1 != c.indexOf("<") && (c = c.replace(za, "&lt;")),
      -1 != c.indexOf(">") && (c = c.replace(Aa, "&gt;")),
      -1 != c.indexOf('"') && (c = c.replace(Ba, "&quot;")),
      -1 != c.indexOf("'") && (c = c.replace(Ca, "&#39;")),
      -1 != c.indexOf("\x00") && (c = c.replace(Da, "&#0;")));
    a =
      '<iframe width="' +
      a +
      '" height="' +
  ...
  function cc(a) {
    if ("iframe" != a.tagName.toLowerCase()) {
      var b = U(a, "videoid");
      b &&
        ((b = { videoId: b, width: U(a, "width"), height: U(a, "height") }),
        new Y(a, b));
    }
  }
  function Z(a, b) {
  ...
  var ec = v("onYTReady");
  ec && ec();
  var fc = v("onYouTubeIframeAPIReady");
  fc && fc();
  var gc = v("onYouTubePlayerAPIReady");
  gc && gc();
}.call(this));
